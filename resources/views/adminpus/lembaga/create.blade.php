                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('lembaga.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_perpus" class="form-control" value="{{ old('nama_perpus') }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email_lembaga" class="form-control" value="{{ old('email_lembaga') }}" required>
                        </div>

                        <!-- Email Perpustakaan -->
                        <div class="mb-3">
                            <label for="email_perpus" class="form-label">Email Perpustakaan</label>
                            <input type="email" name="email_perpus" class="form-control" value="{{ old('email_perpus') }}" required>
                        </div>
